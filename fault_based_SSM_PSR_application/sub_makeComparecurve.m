...
if(gotRegionYN==0)
  Region_assign='others'; % means global regions
end
...
elseif(strcmp(Region_assign,'SHI')==1)
  NZbor_regional_mean_SSM_used=0.6558; % mean regional NZbor from Table1 in Huang et al. (2024); global mean 
...
elseif(strcmp(Region_assign,'SA')==1)
  NZbor_regional_mean_SSM_used=0.6558; % mean regional NZbor from Table1 in Huang et al. (2024); global mean
elseif(strcmp(Region_assign,'others')==1)
  NZbor_regional_mean_SSM_used=0.6558; % mean regional NZbor from Table1 in Huang et al. (2024); global mean
end
%%%%
...
%----
[pre_S2_PSR,y_lo_PSR,y_high_PSR]=sub_RWR_derived_PSRmodel(RWR_used,Rake_used);
...
[pre_S2_PSR_W_add_Sigma_al,y_lo_PSR_W_add_Sigma_al,y_high_PSR_W_add_Sigma_al]=sub_RWR_derived_PSRmodel(RWR_used_add_Sigma_al,Rake_used);
...
[pre_S2_PSR_W_minus_Sigma_al,y_lo_PSR_W_minus_Sigma_al,y_high_PSR_W_minus_Sigma_al]=sub_RWR_derived_PSRmodel(RWR_used_minus_Sigma_al,Rake_used);
