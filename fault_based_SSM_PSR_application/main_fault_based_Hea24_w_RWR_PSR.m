...
dip_global=80; 
ZBSZ_global_Comp1=18.7113;ZBSZ_global_Comp2=23.6354;ZBSZ_global_Comp3=29.5442; % equivelent to W_{Flt}^{FZS} equal to 19, 24, and 30 km
...
ratio_Zbor_to_ZHypo=0.65; % A ratio between 90th percentile of the global Z_Hypo and Z_bor in the empirical dataset that has finite-fault models, as shown in Fig. S5
ZBSZ_global_star1=round(ratio_Zbor_to_ZHypo*ZBSZ_global_Comp1*10)/10;
ZBSZ_global_star2=round(ratio_Zbor_to_ZHypo*ZBSZ_global_Comp2*10)/10;
ZBSZ_global_star3=round(ratio_Zbor_to_ZHypo*ZBSZ_global_Comp3*10)/10;
W_flt_Comp_star1=ZBSZ_global_star1/sind(dip_global);
W_flt_Comp_star2=ZBSZ_global_star2/sind(dip_global);
W_flt_Comp_star3=ZBSZ_global_star3/sind(dip_global);
%---- Legend text for Mea25
legend_inMea25_1=['Mea25, AGG, SS, \nu=',num2str(dip_global),'^\circ, W_F_l_t^F^Z^S*=',num2str(round(W_flt_Comp_star1*10)/10),'km'];
legend_inMea25_2=['Mea25, AGG, SS, \nu=',num2str(dip_global),'^\circ, W_F_l_t^F^Z^S*=',num2str(round(W_flt_Comp_star2*10)/10),'km'];
legend_inMea25_3=['Mea25, AGG, SS, \nu=',num2str(dip_global),'^\circ, W_F_l_t^F^Z^S*=',num2str(round(W_flt_Comp_star3*10)/10),'km'];
%----
outfignm='Mea25_case1';
[Mw_Mea25_case1,P_Mea25_case1]=sub_Mea25(2,5,'AGG_S',80,0.01,1,ZBSZ_global_star1,0.01,1,outfignm);
outfignm='Mea25_case2';
[Mw_Mea25_case2,P_Mea25_case2]=sub_Mea25(2,5,'AGG_S',80,0.01,1,ZBSZ_global_star2,0.01,1,outfignm);
outfignm='Mea25_case3';
[Mw_Mea25_case3,P_Mea25_case3]=sub_Mea25(2,5,'AGG_S',80,0.01,1,ZBSZ_global_star3,0.01,1,outfignm);
