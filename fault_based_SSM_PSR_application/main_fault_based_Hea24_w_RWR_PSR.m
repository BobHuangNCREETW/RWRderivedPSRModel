...
ZBSZ_CA_Comp1=9.8481;ZBSZ_CA_Comp2=14.7721;ZBSZ_CA_Comp3=19.6962; % equivelent to W_{Flt}^{FZS} equal to 5, 10, and 20 km
...
legend_in1=['Hea24 (CA, W_F_l_t^F^Z^S=',num2str(round(W_flt_Comp1*10)/10),'km, ',sprintf('\n'),'        w/o FS, '];
legend_in2=['Hea24 (CA, W_F_l_t^F^Z^S=',num2str(round(W_flt_Comp2*10)/10),'km, ',sprintf('\n'),'        w/o FS, '];
legend_in3=['Hea24 (CA, W_F_l_t^F^Z^S=',num2str(round(W_flt_Comp3*10)/10),'km, ',sprintf('\n'),'        w/o FS, '];
legendshiftx=0.57;
