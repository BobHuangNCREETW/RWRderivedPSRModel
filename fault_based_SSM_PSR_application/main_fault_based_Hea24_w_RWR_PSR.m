...
%-----
Lon_CA=-122.235;Lat_CA=37.858; % for identification only, not used because the regional term (RT(M)) is turned off in Hea24
M_CA_used=4.8:0.1:8;
dip_CA=80; % an example fixed fault dip angle
Rake_CA_used=0; % set SS
...
legendshiftx=0.57;
%--- Calculate and plot the translated progress for Hea24 combined with the S2-PSR model (Fig. A2 in Appendix).
title_in=['\nu=',num2str(dip_CA),'^\circ'];
outnm='Progress_CA_ZBSZ_scaling';
[pre_S2_PSR1_CA_FZS_WFlt5,pre_S2_PSR1_CA_FZS_WFlt5_Psigmaal,pre_S2_PSR1_CA_FZS_WFlt5_Msigmaal,pre_S2_PSR1_CA_FZS_WFlt10,pre_S2_PSR1_CA_FZS_WFlt10_Psigmaal,pre_S2_PSR1_CA_FZS_WFlt10_Msigmaal,pre_S2_PSR1_CA_FZS_WFlt20,pre_S2_PSR1_CA_FZS_WFlt20_Psigmaal,pre_S2_PSR1_CA_FZS_WFlt20_Msigmaal,RWR_used1_CA_FZS_WFlt5,RWR_used2_CA_FZS_WFlt10,RWR_used3_CA_FZS_WFlt20]=sub_pt_progress_comp_threecurves(Lon_CA,Lat_CA,Rake_CA_used,M_CA_used,dip_CA,ZBSZ_CA_Comp1,dip_CA,ZBSZ_CA_Comp2,dip_CA,ZBSZ_CA_Comp3,legend_in1,legend_in2,legend_in3,title_in,legendshiftx,outnm);
%--- Calculate Mea25 from Mammarella et al. EQS (2025), doi: 10.1177/87552930241293570, for comparison.
%---- Legend text for Mea25
legend_inMea25_1=['Mea25, CA, SS, \nu=',num2str(dip_CA),'^\circ, Z_B_S_Z=',num2str(round(ZBSZ_CA_Comp1*10)/10),'km'];
legend_inMea25_2=['Mea25, CA, SS, \nu=',num2str(dip_CA),'^\circ, Z_B_S_Z=',num2str(round(ZBSZ_CA_Comp2*10)/10),'km'];
legend_inMea25_3=['Mea25, CA, SS, \nu=',num2str(dip_CA),'^\circ, Z_B_S_Z=',num2str(round(ZBSZ_CA_Comp3*10)/10),'km'];
%----
outfignm='Mea25_case1';
[Mw_Mea25_case1,P_Mea25_case1]=sub_Mea25(2,5,'CA_S',80,2,2.5,ZBSZ_CA_Comp1,2,1,outfignm);
outfignm='Mea25_case2';
[Mw_Mea25_case2,P_Mea25_case2]=sub_Mea25(2,5,'CA_S',80,2,2.5,ZBSZ_CA_Comp2,2,1,outfignm);
outfignm='Mea25_case3';
[Mw_Mea25_case3,P_Mea25_case3]=sub_Mea25(2,5,'CA_S',80,2,2.5,ZBSZ_CA_Comp3,2,1,outfignm);
% plot for comparison (Fig. 14 (a))
legend_PSR_in1=['S2-PSR, SS; W_R_u_p: Hea24 (W_F_l_t^F^Z^S=',num2str(round(W_flt_Comp1*10)/10),'km)'];
legend_PSR_in2=['S2-PSR, SS; W_R_u_p: Hea24 (W_F_l_t^F^Z^S=',num2str(round(W_flt_Comp2*10)/10),'km)'];
legend_PSR_in3=['S2-PSR, SS; W_R_u_p: Hea24 (W_F_l_t^F^Z^S=',num2str(round(W_flt_Comp3*10)/10),'km)'];
outnm='Comp_CA_ZBSZ_scaling';Comp_SoF='SS';
[nu]=sub_pt_RWRPSR_w_other_models(pre_S2_PSR1_CA_FZS_WFlt5,pre_S2_PSR1_CA_FZS_WFlt5_Psigmaal,pre_S2_PSR1_CA_FZS_WFlt5_Msigmaal,pre_S2_PSR1_CA_FZS_WFlt10,pre_S2_PSR1_CA_FZS_WFlt10_Psigmaal,pre_S2_PSR1_CA_FZS_WFlt10_Msigmaal,pre_S2_PSR1_CA_FZS_WFlt20,pre_S2_PSR1_CA_FZS_WFlt20_Psigmaal,pre_S2_PSR1_CA_FZS_WFlt20_Msigmaal,M_CA_used,M_CA_used,M_CA_used,P_Mea25_case1,P_Mea25_case2,P_Mea25_case3,Mw_Mea25_case1,Mw_Mea25_case2,Mw_Mea25_case2,legend_PSR_in1,legend_PSR_in2,legend_PSR_in3,legend_inMea25_1,legend_inMea25_2,legend_inMea25_3,outnm,Comp_SoF);
