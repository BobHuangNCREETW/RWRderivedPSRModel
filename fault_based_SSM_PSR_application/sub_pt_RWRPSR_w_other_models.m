...
nu='';
%---- generate PSR from Pizza et al. (2023) with different fault type
example_M_Pea23=5.5:0.1:7.9;
example_M_Pea23_SS=5.5:0.1:7.8;example_M_Pea23_RV=5.5:0.1:7.9;example_M_Pea23_NML=5.5:0.1:7.1; % in their table 2
...
pre_ztmp_model_Mw_Pea23_NML=c0_NML_M_Pea23+(example_M_Pea23_NML.*c1_NML_M_Pea23);
...
pre_ztmp_model_Mw_Pea23_RV=c0_RV_M_Pea23+(example_M_Pea23_RV.*c1_RV_M_Pea23);
...
pre_ztmp_model_Mw_Pea23_SS=c0_SS_M_Pea23+(example_M_Pea23_SS.*c1_SS_M_Pea23);
logitfit_model_Mw_Pea23_SS=(exp(pre_ztmp_model_Mw_Pea23_SS))./(1+(exp(pre_ztmp_model_Mw_Pea23_SS)));
example_M_extrapolate_Pea23=4.7:0.1:8.0;
pre_ztmp_model_Mw_extrapolate_Pea23_NML=c0_NML_M_Pea23+(example_M_extrapolate_Pea23.*c1_NML_M_Pea23);
logitfit_model_Mw_extrapolate_Pea23_NML=(exp(pre_ztmp_model_Mw_extrapolate_Pea23_NML))./(1+(exp(pre_ztmp_model_Mw_extrapolate_Pea23_NML)));
pre_ztmp_model_Mw_extrapolate_Pea23_RV=c0_RV_M_Pea23+(example_M_extrapolate_Pea23.*c1_RV_M_Pea23);
logitfit_model_Mw_extrapolate_Pea23_RV=(exp(pre_ztmp_model_Mw_extrapolate_Pea23_RV))./(1+(exp(pre_ztmp_model_Mw_extrapolate_Pea23_RV)));
pre_ztmp_model_Mw_extrapolate_Pea23_SS=c0_SS_M_Pea23+(example_M_extrapolate_Pea23.*c1_SS_M_Pea23);
logitfit_model_Mw_extrapolate_Pea23_SS=(exp(pre_ztmp_model_Mw_extrapolate_Pea23_SS))./(1+(exp(pre_ztmp_model_Mw_extrapolate_Pea23_SS)));
%---- generate PSR from Youngs et al. (2003) all types
...
%---- generate PSR from Moss and Ross (2011) RV types
...
example_M_extrapolate_MR11=4.7:0.1:8;
pre_ztmp_model_Mw_extrapolate_MR11=c0_S1_M_MR11+(example_M_extrapolate_MR11.*c1_S1_M_MR11);
logitfit_model_Mw_extrapolate_MR11=(1./(1+(exp(pre_ztmp_model_Mw_extrapolate_MR11))));
%---- 
if(strcmp(Comp_SoF,'SS')==1)
  Comp_P1=logitfit_model_Mw_Pea23_SS;Comp_M1=example_M_Pea23_SS;
  Comp_P1_extrapolate=logitfit_model_Mw_extrapolate_Pea23_SS;Comp_M1_extrapolate=example_M_extrapolate_Pea23;
  Comp_P2=logitfit_model_Mw_Yea03;Comp_M2=example_M_Yea03;
  Leg_Comp1='Pea23, SS';Leg_Comp2='Yea03, all SoF';
elseif(strcmp(Comp_SoF,'RV')==1)
  Comp_P1=logitfit_model_Mw_Pea23_RV;Comp_M1=example_M_Pea23_RV;
  Comp_P1_extrapolate=logitfit_model_Mw_extrapolate_Pea23_RV;Comp_M1_extrapolate=example_M_extrapolate_Pea23;
  Comp_P2=logitfit_model_Mw_Yea03;Comp_M2=example_M_Yea03;
  Comp_P3=logitfit_model_Mw_MR11;Comp_M3=example_M_MR11;
  Comp_P3_extrapolate=logitfit_model_Mw_extrapolate_MR11;Comp_M3_extrapolate=example_M_extrapolate_MR11;
  Leg_Comp1='Pea23, RV';Leg_Comp2='Yea03, all SoF';
  Leg_Comp3='MR11, RV';
elseif(strcmp(Comp_SoF,'NML')==1)
  Comp_P1=logitfit_model_Mw_Pea23_NML;Comp_M1=example_M_Pea23_NML;
  Comp_P1_extrapolate=logitfit_model_Mw_extrapolate_Pea23_NML;Comp_M1_extrapolate=example_M_extrapolate_Pea23;
  Comp_P2=logitfit_model_Mw_Yea03;Comp_M2=example_M_Yea03;
  Leg_Comp1='Pea23, NML';Leg_Comp2='Yea03, all SoF';
end  
%%% evaluate regions
...
H1=subplot(2,1,1);
  ...
  plot(Mea24_CPSR_M1,log10(Mea24_CPSR_P1),'-o','color',[255/255 142/255 85/255],'linewidth',1);
  plot(Mea24_CPSR_M2,log10(Mea24_CPSR_P2),'-s ','color',[255/255 142/255 85/255],'linewidth',1);
  plot(Mea24_CPSR_M3,log10(Mea24_CPSR_P3),'-^ ','color',[255/255 142/255 85/255],'linewidth',1);
  if(strcmp(Comp_SoF,'RV')==1)
    ...
    po=get(LH,'position');set(LH,'position',[po(1)-0.06,po(2)-0.06,po(3)*0.7,po(4)*0.7],'FontSize',12,'fontweight','bold');
  else
    plot(Comp_M1,log10(Comp_P1),'linestyle','-','color','g','linewidth',1.5);
    plot(Comp_M2,log10(Comp_P2),'linestyle','-','color',[0.4,0.4,0.4],'linewidth',1.5);
    ...
    if(strcmp(region,'SHI')==1)
      po=get(LH,'position');set(LH,'position',[po(1)-0.06,po(2)-0.03,po(3)*0.7,po(4)*0.7],'FontSize',12,'fontweight','bold');
    else
      po=get(LH,'position');set(LH,'position',[po(1)-0.06,po(2)-0.03,po(3)*0.7,po(4)*0.7],'FontSize',12,'fontweight','bold');
    end
  end
  if(strcmp(Comp_SoF,'RV')==1)
    plot(Comp_M1_extrapolate,log10(Comp_P1_extrapolate),'linestyle','--','color','g','linewidth',1.5);
    plot(Comp_M1,log10(Comp_P1),'linestyle','-','color','g','linewidth',1.5);
    plot(Comp_M3,log10(Comp_P3),'linestyle','-','color',[0.7,0.7,0.7],'linewidth',1.5);
    plot(Comp_M3_extrapolate,log10(Comp_P3_extrapolate),'linestyle','--','color',[0.7,0.7,0.7],'linewidth',1.5);
    plot(Comp_M2,log10(Comp_P2),'linestyle','-','color',[0.4,0.4,0.4],'linewidth',1.5);
  else
    plot(Comp_M1_extrapolate,log10(Comp_P1_extrapolate),'linestyle','--','color','g','linewidth',1.5);
    plot(Comp_M1,log10(Comp_P1),'linestyle','-','color','g','linewidth',1.5);
...
%----
  ...
  ylabel('PSR','FontSize',16,'fontweight','bold');
  xlim([4.8,8.2]);
  ylim([-2 0]);
H2=subplot(2,1,2);
  ...
  plot(Mea24_CPSR_M1,Mea24_CPSR_P1,'-o','color',[255/255 142/255 85/255],'linewidth',1);
  plot(Mea24_CPSR_M2,Mea24_CPSR_P2,'-s ','color',[255/255 142/255 85/255],'linewidth',1);
  plot(Mea24_CPSR_M3,Mea24_CPSR_P3,'-^ ','color',[255/255 142/255 85/255],'linewidth',1);
  if(strcmp(Comp_SoF,'RV')==1)
    plot(Comp_M1_extrapolate,Comp_P1_extrapolate,'linestyle','--','color','g','linewidth',1.5);
    plot(Comp_M1,Comp_P1,'linestyle','-','color','g','linewidth',1.5);
    plot(Comp_M3_extrapolate,Comp_P3_extrapolate,'linestyle','--','color',[0.7,0.7,0.7],'linewidth',1.5);
