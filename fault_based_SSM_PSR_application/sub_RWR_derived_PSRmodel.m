...
%                          by the fault width.
%      Rake:             For global SoF-Model use includes SoF consideration. 
%                        If rake = -999, meaning do not consider SoF and use the 
%                          global all SoF model by considering RWR term only.
%      ****************
%      *** Outputs: ***
...
%-------------------------------------------------------
%--- The parameters used are derived from all earthquake data in Table S1, and are listed in Table 2
if(Rake==-999)
  alpha = 1.555;
  var_alpha=0.0194;
